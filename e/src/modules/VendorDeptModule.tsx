...
const VendorDeptModule: React.FC = () => {
	...
	useEffect(() => {
		...
		setOrders(prevOrders => {
			...
			if (updated) {
				console.log('[VendorDept] Persisting synced orders to localStorage');
	...
	useEffect(() => {
		...
		setOrders(prevOrders => {
			...
			if (updated) {
				console.log('[VendorDept] Persisting cleaned orders to localStorage');
				localStorage.setItem('vendorDeptData', JSON.stringify(cleanedOrders));
			}
